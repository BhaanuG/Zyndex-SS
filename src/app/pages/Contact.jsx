...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // 1. Submit message to backend first
      await feedbackService.submitContact(formData);
      ...
      const msg = emailSent
        ? `Thank you, ${formData.name}! Your message about "${formData.subject}" has been sent successfully. We'll respond to ${formData.email} within 24-48 hours.`
        : `Thank you, ${formData.name}! Your message has been received on our servers, but the confirmation email could not be sent. We'll review your query soon.`;
